...
const About = () => {
  return (
    <div
      className="w-full md:h-screen p-2 flex items-center py-16 dark:bg-dark dark:text-light ease-in-out duration-700 transition-colors"
      id="about"
    >
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        ...
        <div className="w-full h-auto m-auto shadow-xl dark:shadow-[0_0px_10px_2px_#9ca3af81] shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300">
          <img
